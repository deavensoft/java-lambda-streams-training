...
public class OptionalExample {
	...
	private static void mapExample() {
		...
		Optional<Integer> sizeOptional = stringOptional.map(String::length); // map
																				// from
																				// Optional<String>
																				// to
																				// Optional<Integer>
		...
		Optional<Integer> sizeOptionalNull = stringOptionalNull.map(x -> x.length()); // we
																						// can
																						// use
																						// Lambdas
																						// as
	...
	private static void typicalNullPointer() {
		try {
			/*
			 * typical NullPointerException, even the compiler is saying
			 * something: Null pointer access: The variable strNull can only be
