...
public class PagingResultsAssignment {
	...
	public List<Employee> sortByLastname(Set<Employee> employeeSet) {
		return this.sortedEmployeesStream(employeeSet, 
	...
	public List<Employee> pagedResult(Set<Employee> employeeSet, Comparator<Employee> comparator, 
		...
		Stream<Employee> sortedEmployeesStream = sortedEmployeesStream(employeeSet, comparator);
		return sortedEmployeesStream
				.skip((long) (pageNumber - 1) * resultsPerPage)
