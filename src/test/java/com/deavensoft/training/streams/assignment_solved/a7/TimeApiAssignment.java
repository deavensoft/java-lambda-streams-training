package com.deavensoft.training.streams.assignment_solved.a7;
...
public class TimeApiAssignment {
	...
	public boolean isDateWithinPeriod(LocalDate date, LocalDate startDate, Period period) {
		LocalDate periodStart = startDate.minusDays(1);
		LocalDate periodEnd = periodStart.plusDays(period.get(ChronoUnit.DAYS) + 1);
	...
	public Set<LocalDate> findDatesAfter(Set<LocalDate> dates, String startingDate) {
		LocalDate start = LocalDate.parse(startingDate, DateTimeFormatter.ISO_LOCAL_DATE);
