package com.deavensoft.training.streams.assignment_solved.a5;
...
public class PagingResultsTest {
	...
	public void testSortedEmployeesStream() {
		List<Employee> actual = assignment.sortedEmployeesStream(employeeSet, compareByFirstname)
	...
	private final Comparator<Employee> compareByAge = Comparator.comparing(Employee::getAge).thenComparing(Employee::getFirstname);
}
